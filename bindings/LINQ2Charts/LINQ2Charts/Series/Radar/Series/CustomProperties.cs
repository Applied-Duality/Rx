...
namespace System.Linq.Charting
{
    partial class Radar
    {
        ...
        /// <summary>
        /// Specifies the drawing style of the Radar chart type.
        /// </summary>
        public RadarDrawingStyle RadarDrawingStyle
        {
            get { return this.Get<RadarDrawingStyle>("RadarDrawingStyle"); }
            set { this.Set("RadarDrawingStyle", value > 0 ? value : 0); }
        }
    }
}
